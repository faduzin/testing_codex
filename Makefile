...
OBJ=ast.o tabela_simbolos.o semantico.o codigo_intermediario.o cmenos.tab.o lex.yy.o main.o
...
codigo_intermediario.o: codigo_intermediario.c codigo_intermediario.h ast.h
